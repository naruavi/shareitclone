...
public class ChatManager implements Runnable {
    ...
    public void run() {
        try {
            ...
            int bytes;
            //Log.d(TAG, "SENDING USERNAME TO GROUP OWNER " + WiFiServiceDiscoveryActivity.usercode + WiFiServiceDiscoveryActivity.username);
            write((WiFiServiceDiscoveryActivity.usercode + WiFiServiceDiscoveryActivity.uname).getBytes());
