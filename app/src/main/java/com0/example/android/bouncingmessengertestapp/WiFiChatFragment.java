                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        if (groupChatManager != null) {
                            ...
                            groupChatManager.tellToEveryone((WiFiServiceDiscoveryActivity.uname+": "+chatLine.getText().toString())
                                    .getBytes());
                            chatLine.setText("");
                            //chatLine.clearFocus();
                        }
                            ...
                            pushMessage("Me: " + chatLine.getText().toString());
                            chatManager.write((WiFiServiceDiscoveryActivity.uname + ": " + chatLine.getText().toString())
                                    .getBytes());
                            chatLine.setText("");
                        }
                    }
